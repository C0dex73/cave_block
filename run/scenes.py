...
class Menu: #to handle the menu display
    def __init__(self, screen, pygame, Data): #called while initializing the class
        ...
        self.font = self.pygame.font.Font("textures/font.ttf", 100) #set the font
...
class Options: #to handle the option menu display
    def __init__(self, screen, pygame, Data): #called when initializing this class
        ...
        self.Data = Data
        self.next = self #set the next scene to itself
        self.font1 = self.pygame.font.Font("textures/font.ttf", 100) #set the fonts
        self.font2 = self.pygame.font.Font("textures/font2.ttf", 25)
    ...
    def tick(self, screen, events, keys): #called every active tick
        ...
        if testKey(self.Data["inputs"]["right"], keys, self.pygame):
            self.pygame.draw.rect(screen, (0, 255, 0), self.pygame.Rect(600, 60, 25, 25), border_radius=2)
        else:
            self.pygame.draw.rect(screen, (255, 0, 0), self.pygame.Rect(600, 60, 25, 25), border_radius=2)
        #text
        ...
        if testKey(self.Data["inputs"]["left"], keys, self.pygame):
            self.pygame.draw.rect(screen, (0, 255, 0), self.pygame.Rect(600, 135, 25, 25), border_radius=2)
        else:
            self.pygame.draw.rect(screen, (255, 0, 0), self.pygame.Rect(600, 135, 25, 25), border_radius=2)
        #text
        ...
        if testKey(self.Data["inputs"]["jump"], keys, self.pygame):
            self.pygame.draw.rect(screen, (0, 255, 0), self.pygame.Rect(600, 210, 25, 25), border_radius=2)
        else:
            self.pygame.draw.rect(screen, (255, 0, 0), self.pygame.Rect(600, 210, 25, 25), border_radius=2)
        #text
        ...
        if testKey(self.Data["inputs"]["crouch"], keys, self.pygame):
            self.pygame.draw.rect(screen, (0, 255, 0), self.pygame.Rect(600, 285, 25, 25), border_radius=2)
        else:
            self.pygame.draw.rect(screen, (255, 0, 0), self.pygame.Rect(600, 285, 25, 25), border_radius=2)
        #text
        ...
        if testKey(self.Data["inputs"]["shoot"], keys, self.pygame):
            self.pygame.draw.rect(screen, (0, 255, 0), self.pygame.Rect(600, 360, 25, 25), border_radius=2)
        else:
            self.pygame.draw.rect(screen, (255, 0, 0), self.pygame.Rect(600, 360, 25, 25), border_radius=2)
        #text
